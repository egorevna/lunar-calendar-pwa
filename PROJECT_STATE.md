...
```txt
Sprint 13 — Special Points Foundation closed
```
...
- следующая активная задача — Sprint 14 planning — Fixed Stars; Sprint 14 implementation не начат.
...
- следующая активная задача — Sprint 14 planning — Fixed Stars;
...
2. Не начинать Sprint 14 implementation без отдельной команды пользователя.
3. Объяснить минимальный план изменения.
4. Внести только необходимые изменения.
5. Не начинать Fixed Stars implementation без отдельного явного запроса.
