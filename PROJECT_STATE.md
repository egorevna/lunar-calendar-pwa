...
- следующая активная задача — Task 14.5 — Fixed Star Target Resolver; Task 14.5 не начата.
...
- следующая активная задача — Task 14.5 — Fixed Star Target Resolver;
...
2. Не начинать Task 14.5 без отдельной команды пользователя.
3. Объяснить минимальный план изменения.
4. Внести только необходимые изменения.
5. Не начинать Fixed Stars conjunction implementation до validated target resolver.
