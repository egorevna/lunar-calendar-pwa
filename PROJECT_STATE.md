...
- активная задача — Task 11.6, Planet-in-House Assignment for Selected House System;
...
2. Работать только над Task 11.6 после отдельной команды пользователя.
3. Объяснить минимальный план изменения.
4. Внести только необходимые изменения.
5. В Task 11.6 добавить planet-in-house assignment for selected house system without UI.
