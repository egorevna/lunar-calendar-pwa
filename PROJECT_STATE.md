...
- следующая активная задача — Task 12.5 — Arabic Parts Source Decision / Formula Dataset;
...
2. Работать только над Task 12.5 после отдельной команды пользователя.
3. Объяснить минимальный план изменения.
4. Внести только необходимые изменения.
5. Не начинать Task 12.5 без отдельного явного запроса.
