...
- следующая активная задача — Task 13.2 — Lunar Nodes Source / Calculation Policy;
...
2. Работать только над Task 13.2 после отдельной команды пользователя.
3. Объяснить минимальный план изменения.
4. Внести только необходимые изменения.
5. Не начинать Task 13.2 без отдельного явного запроса.
