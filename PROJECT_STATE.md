...
- добавить фундамент локальных профилей / карт;
- сохранить расчеты главного экрана общими до следующих спринтов;
- подготовить privacy-first модель данных.
...
Стартовать нужно с модели профиля и validation helpers. Хранилище, UI и localStorage идут позже по задачам Sprint 3.
...
Sprint 3 — Profiles / Мои карты — активный спринт.
...
```txt
Выполнить Task 3.1 — Add Profile Data Model.
```

Перед реализацией Codex должен:

1. Работать строго по `TODO.md`.
2. Не начинать Task 3.2.
...
Sprint 1 и Sprint 2 завершены. Активный спринт — Sprint 3; следующая реализационная задача — Task 3.1.
