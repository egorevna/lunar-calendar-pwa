...
- активная задача — Task 11.9, Houses / ASC / MC Debug;
...
2. Работать только над Task 11.9 после отдельной команды пользователя.
3. Объяснить минимальный план изменения.
4. Внести только необходимые изменения.
5. В Task 11.9 добавить safe debug для Houses / ASC / MC.
