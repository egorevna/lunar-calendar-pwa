...
- активная задача — Task 11.8, Houses / ASC / MC Collapsible UI;
...
2. Работать только над Task 11.8 после отдельной команды пользователя.
3. Объяснить минимальный план изменения.
4. Внести только необходимые изменения.
5. В Task 11.8 добавить collapsible UI для готовых Houses / ASC / MC display results.
