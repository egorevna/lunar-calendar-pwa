...
- следующая активная задача — Task 14.7 — Fixed Star Validation / Cross-Checks; Task 14.7 не начата.
...
- следующая активная задача — Task 14.7 — Fixed Star Validation / Cross-Checks;
...
2. Не начинать Task 14.7 без отдельной команды пользователя.
3. Объяснить минимальный план изменения.
4. Внести только необходимые изменения.
5. Не начинать дальнейшие Fixed Stars задачи после Task 14.7 без отдельной команды пользователя.
