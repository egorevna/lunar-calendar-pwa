...
- no formula from memory, hidden formula policy, interpretations, transits, ritual scoring, midpoint engine, antiscia engine, UI or debug were added in Task 16.1 / Task 16.2 / Task 16.3;
- следующая активная задача — Task 16.4 — Midpoint Engine / Fixtures; Task 16.4 не начата.
