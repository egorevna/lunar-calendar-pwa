...
```txt
Sprint 12 — House Cusps + Pars Fortuna + Basic Arabic Parts closed
```
...
- следующая активная задача — Sprint 13 planning;
...
2. Работать только над Sprint 13 planning после отдельной команды пользователя.
3. Объяснить минимальный план изменения.
4. Внести только необходимые изменения.
5. Не начинать Sprint 13 без отдельного явного запроса.
