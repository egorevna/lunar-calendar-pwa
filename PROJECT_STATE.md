...
- Task 14.2 завершена: added `FIXED_STARS_SOURCE_DECISION.md`; primary astrology source is Vronsky Table 18; validation policy is Vronsky primary plus Swiss / modern validation where possible; candidate-only subset is Алголь, Альдебаран, Ригель, Бетельгейзе, Сириус, Канопус, Регул, Спика, Арктур, Антарес, Вега, Альтаир and Фомальгаут; global conjunction orb is `1°00′`; first target set is natal planets + ASC / MC / DSC / IC; no Fixed Stars catalog or engine exists yet;
- следующая активная задача — Task 14.3 — Fixed Star Catalog Dataset / Fixtures; Task 14.3 не начата.
...
- Task 14.2 завершена: added Fixed Stars source/catalog/orb policy; primary source is Vronsky Table 18 with Swiss / modern validation where possible; candidate-only subset is Алголь, Альдебаран, Ригель, Бетельгейзе, Сириус, Канопус, Регул, Спика, Арктур, Антарес, Вега, Альтаир and Фомальгаут; global conjunction orb is `1°00′`; first target set is natal planets + ASC / MC / DSC / IC; no catalog or engine exists yet;
- следующая активная задача — Task 14.3 — Fixed Star Catalog Dataset / Fixtures;
...
2. Не начинать Task 14.3 без отдельной команды пользователя.
3. Объяснить минимальный план изменения.
4. Внести только необходимые изменения.
5. Не начинать Fixed Stars engine implementation до source-tracked catalog dataset / fixtures.
