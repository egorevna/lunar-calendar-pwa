...
- следующая активная задача — Task 12.2 — House Cusp Canonicalization / Fixtures;
...
2. Работать только над Task 12.2 после отдельной команды пользователя.
3. Объяснить минимальный план изменения.
4. Внести только необходимые изменения.
5. Не начинать Task 12.2 / Sprint 12 implementation tasks без отдельного явного запроса.
