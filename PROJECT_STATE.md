...
```txt
Sprint 11 — Houses / ASC / MC closed
```
...
- Sprint 11 закрыт; следующая активная задача — Sprint 12 planning — House Cusps + Pars Fortuna + Basic Arabic Parts;
...
2. Работать только над Sprint 12 planning после отдельной команды пользователя.
3. Объяснить минимальный план изменения.
4. Внести только необходимые изменения.
5. Не начинать Sprint 12 implementation tasks без отдельного явного запроса.
