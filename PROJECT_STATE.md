...
- следующая активная задача — Task 13.9 — Special Points Display Helper;
...
2. Работать только над Task 13.9 после отдельной команды пользователя.
3. Объяснить минимальный план изменения.
4. Внести только необходимые изменения.
5. Не начинать Task 13.9 без отдельного явного запроса.
