...
- активная задача — Task 10.8f, Table 7 Vronsky Degree Rulers Lookup Engine / Fixtures;
...
2. Работать только над Task 10.8f после отдельной команды пользователя.
3. Объяснить минимальный план изменения.
4. Внести только необходимые изменения.
5. В Task 10.8f создавать только lookup engine / fixtures over verified Table 7 dataset; не создавать UI, Table 6 changes, houses / ASC / MC, interpretations или OCR-only rows.
