...
- `test/fieldQuality.test.js` — тесты советов и нескольких типов поля.
...
Не начинать Task 1.6 без отдельной команды пользователя.
...
```txt
Выполнить Task 1.6 — Add Warnings Block.
```
