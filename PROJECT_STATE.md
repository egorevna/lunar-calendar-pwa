...
- Task 12.6 завершена: добавлен pure Basic Arabic Parts engine `src/arabicParts.js`; active verified formulas calculated are `pars-fortuna` and `lot-of-spirit`; deferred Arabic Parts remain inactive; house assignment is not implemented yet;
- следующая активная задача — Task 12.7 — Lots / Arabic Parts House Assignment;
...
2. Работать только над Task 12.7 после отдельной команды пользователя.
3. Объяснить минимальный план изменения.
4. Внести только необходимые изменения.
5. Не начинать Task 12.7 без отдельного явного запроса.
