...
- активная задача — Task 10.8e, Table 7 Vronsky Degree Rulers Dataset;
...
2. Работать только над Task 10.8e после отдельной команды пользователя.
3. Объяснить минимальный план изменения.
4. Внести только необходимые изменения.
5. В Task 10.8e создавать только active Table 7 dataset from verified/cross-referenced rows; не создавать lookup engine, UI, Table 6 changes, houses / ASC / MC, interpretations или OCR-only rows.
