...
- следующая активная задача — Task 15.2c — Vronsky Arabic Points Scope Selection; Task 15.2c не начата.
...
- Sprint 14 закрыт;
- Task 15.1 завершена: Sprint 15 Arabic Parts Expansion Pack strategy docs accepted; Task 15.2 завершена as blocked/source-materials-required; Task 15.2b завершена as Vronsky Table 17 source-materials intake; следующая активная задача — Task 15.2c — Vronsky Arabic Points Scope Selection;
...
2. Не начинать Task 15.2c без отдельной команды пользователя.
