...
```txt
Sprint 15 — Arabic Parts Expansion Pack active
```
...
- следующая активная задача — Task 15.8 — Vronsky Arabic Points Final Hardening / Regression; Task 15.8 не начата.
