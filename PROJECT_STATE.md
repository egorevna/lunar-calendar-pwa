...
- следующая активная задача — Task 14.11 — Fixed Stars Final Hardening / Regression; Task 14.11 не начата.
...
- следующая активная задача — Task 14.11 — Fixed Stars Final Hardening / Regression;
...
2. Не начинать Task 14.11 без отдельной команды пользователя.
3. Объяснить минимальный план изменения.
4. Внести только необходимые изменения.
5. Не начинать дальнейшие Fixed Stars задачи после Task 14.11 без отдельной команды пользователя.
