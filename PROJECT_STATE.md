...
- current Placidus integration recognizes the system but remains explicit deferred / unsupported because no validated path plus benchmark fixtures exists;
