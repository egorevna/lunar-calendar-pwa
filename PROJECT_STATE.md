...
- no formula from memory, hidden formula policy, interpretations, transits, ritual scoring, midpoint contacts, midpoint pictures, antiscia engine, UI or debug were added in Task 16.1 / Task 16.2 / Task 16.3 / Task 16.4;
- следующая активная задача — Task 16.5 — Midpoint Validation / Cross-Checks; Task 16.5 не начата.
