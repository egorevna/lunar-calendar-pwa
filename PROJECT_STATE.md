...
- активная задача — Task 11.7, Houses / ASC / MC Display Helper;
...
2. Работать только над Task 11.7 после отдельной команды пользователя.
3. Объяснить минимальный план изменения.
4. Внести только необходимые изменения.
5. В Task 11.7 добавить display helper для Houses / ASC / MC without UI.
