...
- активная задача — Task 10.7d, Degree Rulers Table 6 Dataset from Verified Rows;
...
2. Работать только над Task 10.7d после отдельной команды пользователя.
3. Объяснить минимальный план изменения.
4. Внести только необходимые изменения.
5. В Task 10.7d создавать только active structured dataset from verified Table 6 rows; не делать UI, lookup engine, Table 7 rows, Vronsky degree rows, exact exaltation degrees, натальную карту, персональные транзиты, дома, ASC/MC, интерпретации или фейковые личные расчеты.
