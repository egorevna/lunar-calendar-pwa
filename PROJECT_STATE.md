...
- Task 15.2 завершена as blocked/source-materials-required: `ARABIC_PARTS_SOURCE_CORPUS_DECISION.md` records that no local verified source corpus is available for Eros / Necessity / Basis / Exaltation, so Task 15.3 cannot proceed yet;
- следующая активная задача — Task 15.2b — Arabic Parts Source Materials Intake; Task 15.2b не начата.
...
- Sprint 14 закрыт;
- Task 15.1 завершена: Sprint 15 Arabic Parts Expansion Pack strategy docs accepted; Task 15.2 завершена as blocked/source-materials-required; следующая активная задача — Task 15.2b — Arabic Parts Source Materials Intake;
...
2. Не начинать Task 15.2b без отдельной команды пользователя.
