...
- следующая активная задача — Task 13.8 — Selena Engine / Fixtures;
...
2. Работать только над Task 13.8 после отдельной команды пользователя.
3. Объяснить минимальный план изменения.
4. Внести только необходимые изменения.
5. Не начинать Task 13.8 без отдельного явного запроса.
