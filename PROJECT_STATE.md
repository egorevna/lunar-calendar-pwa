...
- следующая активная задача — Task 15.3 — Vronsky Simple Arabic Points Dataset / Fixtures; Task 15.3 не начата.
...
- Sprint 14 закрыт;
- Task 15.1 завершена: Sprint 15 Arabic Parts Expansion Pack strategy docs accepted; Task 15.2 завершена as blocked/source-materials-required; Task 15.2b завершена as Vronsky Table 17 source-materials intake; Task 15.2c завершена as Vronsky Arabic Points scope selection; следующая активная задача — Task 15.3 — Vronsky Simple Arabic Points Dataset / Fixtures;
...
2. Не начинать Task 15.3 без отдельной команды пользователя.
