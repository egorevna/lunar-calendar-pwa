...
- следующая активная задача — Task 12.11 — Sprint 12 Hardening;
...
2. Работать только над Task 12.11 после отдельной команды пользователя.
3. Объяснить минимальный план изменения.
4. Внести только необходимые изменения.
5. Не начинать Task 12.11 без отдельного явного запроса.
