...
- активная задача — Task 10.8, Degree Rulers Lookup Engine / Fixtures;
...
2. Работать только над Task 10.8 после отдельной команды пользователя.
3. Объяснить минимальный план изменения.
4. Внести только необходимые изменения.
5. В Task 10.8 создавать только pure lookup engine / fixtures over verified Table 6 dataset; не делать UI, Table 7 rows, Vronsky degree rows, exact exaltation degrees, натальную карту, персональные транзиты, дома, ASC/MC, интерпретации или фейковые личные расчеты.
