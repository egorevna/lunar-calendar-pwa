...
- следующая активная задача — Task 15.2 — Source Corpus / Formula Tradition Decision; Task 15.2 не начата.
...
- Sprint 14 закрыт;
- Task 15.1 завершена: Sprint 15 Arabic Parts Expansion Pack strategy docs accepted; следующая активная задача — Task 15.2 — Source Corpus / Formula Tradition Decision;
...
2. Не начинать Task 15.2 без отдельной команды пользователя.
