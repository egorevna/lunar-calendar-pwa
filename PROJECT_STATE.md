...
- следующая активная задача — Task 15.6 — Vronsky Arabic Points UI Update; Task 15.6 не начата.
...
- Sprint 14 закрыт;
- Task 15.1 завершена: Sprint 15 Arabic Parts Expansion Pack strategy docs accepted; Task 15.2 завершена as blocked/source-materials-required; Task 15.2b завершена as Vronsky Table 17 source-materials intake; Task 15.2c завершена as Vronsky Arabic Points scope selection; Task 15.3 завершена as Vronsky simple Arabic Points dataset / fixtures; Task 15.4 завершена as Vronsky simple Arabic Points explicit engine / fixtures; Task 15.5 завершена as Vronsky Arabic Points house assignment / display integration; следующая активная задача — Task 15.6 — Vronsky Arabic Points UI Update;
...
2. Не начинать Task 15.6 без отдельной команды пользователя.
