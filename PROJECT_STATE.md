...
- no formula from memory, hidden formula policy, interpretations, transits, ritual scoring, midpoint contacts, midpoint pictures, antiscia engine, UI or debug were added in Task 16.1 / Task 16.2 / Task 16.3 / Task 16.4 / Task 16.5;
- следующая активная задача — Task 16.6 — Antiscia Target Resolver / Fixtures; Task 16.6 не начата.
