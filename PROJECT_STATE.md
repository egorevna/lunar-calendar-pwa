...
- активная задача — Task 11.10, Sprint 11 Hardening;
...
2. Работать только над Task 11.10 после отдельной команды пользователя.
3. Объяснить минимальный план изменения.
4. Внести только необходимые изменения.
5. В Task 11.10 выполнить Sprint 11 hardening.
