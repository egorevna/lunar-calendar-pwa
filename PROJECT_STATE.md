...
- Task 15.3 завершена: added 12 source-tracked Vronsky simple Arabic Points rows to `src/arabicPartsData.js` as inactive / pending-engine metadata with fixtures and tests; active calculated formulas remain exactly `pars-fortuna` and `lot-of-spirit`; no engine expansion/UI/debug was added;
- existing active formulas remain `pars-fortuna` and `lot-of-spirit`;
- следующая активная задача — Task 15.4 — Vronsky Simple Arabic Points Engine Expansion / Fixtures; Task 15.4 не начата.
...
- Sprint 14 закрыт;
- Task 15.1 завершена: Sprint 15 Arabic Parts Expansion Pack strategy docs accepted; Task 15.2 завершена as blocked/source-materials-required; Task 15.2b завершена as Vronsky Table 17 source-materials intake; Task 15.2c завершена as Vronsky Arabic Points scope selection; Task 15.3 завершена as Vronsky simple Arabic Points dataset / fixtures; следующая активная задача — Task 15.4 — Vronsky Simple Arabic Points Engine Expansion / Fixtures;
...
2. Не начинать Task 15.4 без отдельной команды пользователя.
