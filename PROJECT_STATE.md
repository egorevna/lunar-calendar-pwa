...
- no formula from memory, hidden formula policy, interpretations, transits, ritual scoring, calculation modules, UI or debug were added in Task 16.1 / Task 16.2;
- следующая активная задача — Task 16.3 — Midpoint Target Resolver / Fixtures; Task 16.3 не начата.
