...
- Sprint 16 начат: Midpoints / Antiscia Foundation is source/formula/scope-gated; midpoint shortest-arc, antiscion and contra-antiscion formulas remain candidates until Task 16.2 verifies them;
- no formula from memory, hidden formula policy, interpretations, transits, ritual scoring, calculation modules, UI or debug were added in Task 16.1;
- следующая активная задача — Task 16.2 — Midpoints / Antiscia Source / Formula / Scope Policy; Task 16.2 не начата.
