...
- следующая активная задача — Task 13.7 — Selena Source Decision / Feasibility;
...
2. Работать только над Task 13.7 после отдельной команды пользователя.
3. Объяснить минимальный план изменения.
4. Внести только необходимые изменения.
5. Не начинать Task 13.7 без отдельного явного запроса.
