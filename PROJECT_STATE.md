...
- следующая активная задача — Task 14.8 — Fixed Stars Display Helper; Task 14.8 не начата.
...
- следующая активная задача — Task 14.8 — Fixed Stars Display Helper;
...
2. Не начинать Task 14.8 без отдельной команды пользователя.
3. Объяснить минимальный план изменения.
4. Внести только необходимые изменения.
5. Не начинать дальнейшие Fixed Stars задачи после Task 14.8 без отдельной команды пользователя.
