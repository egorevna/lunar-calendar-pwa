...
- следующая активная задача — Task 14.4 — Fixed Star Position / Epoch Engine; Task 14.4 не начата.
...
- следующая активная задача — Task 14.4 — Fixed Star Position / Epoch Engine;
...
2. Не начинать Task 14.4 без отдельной команды пользователя.
3. Объяснить минимальный план изменения.
4. Внести только необходимые изменения.
5. Не начинать Fixed Stars conjunction implementation до validated position / epoch engine.
