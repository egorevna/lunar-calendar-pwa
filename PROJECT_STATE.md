...
- следующая активная задача — Task 12.3 — Day / Night Chart Status Engine / Fixtures;
...
2. Работать только над Task 12.3 после отдельной команды пользователя.
3. Объяснить минимальный план изменения.
4. Внести только необходимые изменения.
5. Не начинать Task 12.3 без отдельного явного запроса.
