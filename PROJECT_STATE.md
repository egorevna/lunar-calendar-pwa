...
- лунный день;
- фазу Луны.
- лунную точность: освещенность, время до ближайшего Новолуния / Полнолуния, возраст Луны.
...
- Task 1.7 завершена: в основной блок Луны добавлены освещенность, время до ближайшего Новолуния / Полнолуния и возраст Луны.
...
Не начинать Task 1.8 без отдельной команды пользователя.
...
```txt
Выполнить Task 1.8 — Add Planetary Hour Hints.
```

Перед реализацией Codex должен:

1. Найти, где сейчас отображается блок `Планетарный час`.
2. Найти, где формируются данные планетарного часа.
