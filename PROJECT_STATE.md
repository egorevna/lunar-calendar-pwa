...
- Sprint 14 начат: Fixed Stars are source-gated; no catalog row may be activated from memory; no hidden orb; no mixed epochs; conjunction-only is the initial relationship policy unless Task 14.2 decides otherwise; no interpretations are allowed;
- следующая активная задача — Task 14.2 — Fixed Stars Source / Catalog / Orb Policy; Task 14.2 не начата.
...
- следующая активная задача — Task 14.2 — Fixed Stars Source / Catalog / Orb Policy;
...
2. Не начинать Task 14.2 без отдельной команды пользователя.
3. Объяснить минимальный план изменения.
4. Внести только необходимые изменения.
5. Не начинать Fixed Stars engine / catalog implementation до source / catalog / orb policy.
