...
- PWA cache is `lunar-calendar-v96`;
- следующая активная задача — Task 15.7 — Vronsky Arabic Points Debug Update; Task 15.7 не начата.
...
- Sprint 14 закрыт;
- Task 15.1 завершена: Sprint 15 Arabic Parts Expansion Pack strategy docs accepted; Task 15.2 завершена as blocked/source-materials-required; Task 15.2b завершена as Vronsky Table 17 source-materials intake; Task 15.2c завершена as Vronsky Arabic Points scope selection; Task 15.3 завершена as Vronsky simple Arabic Points dataset / fixtures; Task 15.4 завершена as Vronsky simple Arabic Points explicit engine / fixtures; Task 15.5 завершена as Vronsky Arabic Points house assignment / display integration; Task 15.6 завершена as Vronsky Arabic Points UI update inside the existing `Жребии и арабские части` block; следующая активная задача — Task 15.7 — Vronsky Arabic Points Debug Update;
