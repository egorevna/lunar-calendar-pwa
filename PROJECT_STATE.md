...
- следующая активная задача — Task 14.6 — Fixed Star Conjunction Engine / Fixtures; Task 14.6 не начата.
...
- следующая активная задача — Task 14.6 — Fixed Star Conjunction Engine / Fixtures;
...
2. Не начинать Task 14.6 без отдельной команды пользователя.
3. Объяснить минимальный план изменения.
4. Внести только необходимые изменения.
5. Не начинать дальнейшие Fixed Stars задачи после Task 14.6 без отдельной команды пользователя.
