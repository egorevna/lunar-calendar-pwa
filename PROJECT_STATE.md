...
```txt
Sprint 14 — Fixed Stars Foundation active
```
...
- Sprint 14 закрыт;
- следующая активная задача — Sprint 15 planning — Arabic Parts Expansion Pack; Sprint 15 не начат.
...
- Sprint 14 закрыт;
- следующая активная задача — Sprint 15 planning — Arabic Parts Expansion Pack;
...
2. Не начинать Sprint 15 без отдельной команды пользователя.
3. Объяснить минимальный план изменения.
4. Внести только необходимые изменения.
5. Не начинать Arabic Parts Expansion Pack без отдельной команды пользователя.
